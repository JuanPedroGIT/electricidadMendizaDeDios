  ...
  <header class="header" :class="{ scrolled: isScrolled }">
    <div class="container">
      <div class="top-bar">
        ...
        <nav class="nav-links">
          <RouterLink v-for="link in navLinks" :key="link.name" :to="link.to">{{ link.name }}</RouterLink>
        </nav>
    ...
    <div v-if="isMobileMenuOpen" class="mobile-menu">
      <div class="container">
        <nav class="mobile-nav">
          <RouterLink v-for="link in navLinks" :key="link.name" :to="link.to" @click="isMobileMenuOpen = false">
            {{ link.name }}
          </RouterLink>
